package ro.igstan.util
{
    public dynamic class CnpValidator
    {
        ...
        protected static const MONTHS_WITH_31_DAYS:Array = [
        ...
        {
            return birthMonthHas31Days() ? 31 : 30;
        }
        
        protected function birthMonthHas31Days():Boolean
        {
            return MONTHS_WITH_31_DAYS.indexOf(birthMonth) !== -1;
        }
